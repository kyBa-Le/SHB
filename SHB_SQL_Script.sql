...
VALUES
    ('2024-12-15', 1500000, 'Payment for clothing order', 'Momo Wallet', 'Hanoi', 'Cau Giay', '23 Duy Tan Street', 'Paid'),
    ('2024-12-16', 800000, 'Payment for jacket', 'Cash', 'Ho Chi Minh City', 'District 1', '45 Le Duan Street', 'Pending'),
    ('2024-12-18', 600000, 'Payment for children’s wear', 'Cash', 'Danang', 'Hai Chau', '56 Tran Phu Street', 'Pending'),
    ('2024-12-19', 400000, 'Payment for sweater', 'Momo Wallet', 'Hanoi', 'Dong Da', '78 Nguyen Chi Thanh Street', 'Paid'),
    ('2024-12-20', 1200000, 'Payment for coats', 'Cash', 'Hue', 'Phu Nhuan', '12 Hung Vuong Street', 'Pending');
